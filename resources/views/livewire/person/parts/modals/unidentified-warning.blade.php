...
<div x-data="{ showUnidentifiedPatientModal: $wire.entangle('showUnidentifiedPatientModal') }">
                ...
                >
                    <div class="flex flex-col gap-6">
                        ...
                        <div class="flex gap-4 xl:flex-row justify-start items-center mt-4">
                            <button type="button" class="button-minor" wire:click="proceedWithoutEncounter">
                                {{ __('patients.unidentified_modal_btn_later') }}
                            </button>
                            <button type="button" class="button-primary" wire:click="proceedWithEncounter">
