        ...
        <template x-teleport="body">
            ...
            >
                ...
                <div id="diagnoses-drawer-right"
                     ...
                     class="fixed top-0 right-0 h-screen pt-20 p-6 bg-white dark:bg-gray-800 shadow-2xl overflow-y-auto border-l border-gray-100 dark:border-gray-700 flex flex-col justify-between"
                     style="z-index: 45; width: calc(80% - 30px); max-width: 900px;"
                     tabindex="-1"
                    ...
                    <div class="flex-1 flex flex-col min-h-0">
                        ...
                        <form class="space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                                <div>
                                    <label for="codingSystem" class="text-xs text-gray-500 dark:text-gray-400 font-medium block mb-1">
                                ...
                                <div>
                                    <div x-show="modalCondition.codeSystem === 'eHealth/ICPC2/condition_codes'">
                                        <label for="conditionReasonCode" class="text-xs text-gray-500 dark:text-gray-400 font-medium block mb-1">
                                    ...
                                    <div x-show="modalCondition.codeSystem === 'eHealth/ICD10_AM/condition_codes'"
                                         ...
                                         class="relative"
                                    >
                                        <label for="icd10Code" class="text-xs text-gray-500 dark:text-gray-400 font-medium block mb-1">
                                    ...
                                    <div x-show="!modalCondition.codeSystem">
                                        ...
                                        <div class="relative">
                                            <input type="text" disabled class="input w-full opacity-50 cursor-not-allowed" placeholder="{{ __('patients.choose_coding_system') }}" />
                                            @icon('chevron-down', 'w-4 h-4 absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 dark:text-gray-500 pointer-events-none')
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <label for="diagnoseCode" class="text-xs text-gray-500 dark:text-gray-400 font-medium block mb-1">
                            ...
                            <div class="mt-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                                <div class="flex flex-wrap items-center gap-6">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <input @change="modalCondition.primarySource = true; modalCondition.asserterText = '';"
                                        ...
                                        >
                                        <label for="performer" class="text-sm font-medium text-gray-900 dark:text-gray-300 cursor-pointer">
                                            {{ __('patients.performer') }}
                                        </label>
                                    </div>

                                    <div class="flex items-center gap-2">
                                        <input @change="modalCondition.primarySource = false; modalCondition.asserterText = '';"
                                               x-model.boolean="modalCondition.primarySource"
                                               id="otherSource"
                                               type="radio"
                                               value="false"
                                        ...
                                        >
                                        <label for="otherSource" class="text-sm font-medium text-gray-900 dark:text-gray-300 cursor-pointer">
                            ...
                            <div x-show="modalCondition.primarySource === false" class="space-y-6 mt-6 transition-all">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <label for="reportOrigin" class="text-xs text-gray-500 dark:text-gray-400 font-medium block mb-1">
                            ...
                            <div x-show="modalCondition.primarySource === true" class="mt-8 transition-all">
                                <div class="form-group group">
                                    <label for="doctorComment" class="text-sm font-bold text-gray-900 dark:text-white block mb-3">{{ __('forms.comment') }}</label>
                                    <textarea rows="4"
                                              x-model="modalCondition.asserterText"
                                              id="doctorComment"
                                              name="doctorComment"
                            ...
                            <div class="mt-8 flex justify-start items-center gap-4">
                                ...
                                >
                                    <span x-text="newCondition ? '{{ __('forms.cancel') }}' : '{{ __('forms.delete') }}'"></span>
                                </button>
                                ...
                                >
                                    <span x-text="newCondition ? '{{ __('patients.add_diagnose') }}' : '{{ __('forms.save') }}'"></span>
                                </button>
                            </div>
                            <div class="mt-2">
