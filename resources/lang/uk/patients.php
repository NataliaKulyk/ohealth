...
return [
    ...
    */
    ...
    'ehealth_status' => 'Статус ЕСОЗ',
    'signing_status' => 'Статус підписання',
    'signed' => 'Підписано',
...
- надає згоду медичному працівнику закладу охорони здоров\'я створити запис про пацієнта у Електронній системі охорони здоров\'я.',
    ...
    'coauthor' => 'Співавтор',
    'add_observations_reports_conditions' => 'Додати медичні спостереження, діагностичні звіти або стани',
    'medical_records_referenced_by_interaction' => 'Медичні записи, на які посилається взаємодія',
    'search_medical_records' => 'Пошук медичних записів',
    'all_types' => 'Всі типи',
    'type_of_medical_records' => 'Тип медичних записів',
    'all_episodes' => 'Всі епізоди',
    'episode' => 'Епізод',
    
    'mock' => [
        'name_A98' => 'A98 Підтримання здоров\'я / Профілактика',
        'episode_1' => 'Підтримання здоров\'я/профілактика (діючий) від 8.05.2025',
        'name_59041_4' => '59041-4 Сатурація кисню (SpO2)',
        'name_11502_2' => '11502-2 Загальний аналіз крові',
        'name_I10' => 'I10 Есенціальна (первинна) гіпертензія',
        'episode_2' => 'Підтримання здоров\'я/профілактика (діючий) від 1.05.2025',
        'name_85354_9' => '85354-9 Артеріальний тиск',
    ],
